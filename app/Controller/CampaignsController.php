 ...
 */
	public function add() {
		...
		$countries = $this->Campaign->Country->find('list');
		$states = $this->Campaign->State->find('list');
		$cities = $this->Campaign->City->find('list');
		$categories = $this->Campaign->Category->find('list');
		$users = $this->Campaign->User->find('list');
		$this->set(compact('countries', 'states', 'cities', 'categories', 'users'));
	}
